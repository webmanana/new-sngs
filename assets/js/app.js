...
/***/ "./node_modules/imports-loader/index.js?jQuery=jquery!./node_modules/owl.carousel/dist/owl.carousel.js":
/*!****************************************************************************************************!*\
  !*** ./node_modules/imports-loader?jQuery=jquery!./node_modules/owl.carousel/dist/owl.carousel.js ***!
  \****************************************************************************************************/
...
/* harmony import */ var imports_loader_jQuery_jquery_owl_carousel__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! imports-loader?jQuery=jquery!owl.carousel */ "./node_modules/imports-loader/index.js?jQuery=jquery!./node_modules/owl.carousel/dist/owl.carousel.js");
/* harmony import */ var imports_loader_jQuery_jquery_owl_carousel__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(imports_loader_jQuery_jquery_owl_carousel__WEBPACK_IMPORTED_MODULE_2__);
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#mainBanner').owlCarousel({
    animateOut: 'fadeOut',
    animateIn: 'fadeIn',
    items: 1,
    margin: 0,
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#newsGallery').owlCarousel({
    items: 3,
    margin: 32,
    loop: false,
    dots: false,
    nav: true,
    navText: ['<img style="transform:rotate(180deg)" src="./img/arrow-h.png" alt="">', '<img src="/marcup/img/arrow-h.png" alt="">'],
    autoplay: false,
    autoWidth: true
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("#searchMain").click(function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#search-form").show();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("input.form-control").focus();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('input.form-control').focusout(function () {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()("#search-form").hide();
    });
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("#searchMain1").click(function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#search-form1").show();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("input.form-control").focus();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('input.form-control').focusout(function () {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()("#search-form1").hide();
    });
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("#fullMenu").click(function () {
    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()("#fullMenu").hasClass('open')) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()("#fullMenu").removeClass('open');
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.full-menu').removeClass('open');
    } else {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()("#fullMenu").addClass('open');
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.full-menu').addClass('open');
    }
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("#fullMenuMobile").click(function () {
    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()("#fullMenuMobile").hasClass('open')) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()("#fullMenuMobile").removeClass('open');
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.full-menu').removeClass('open');
    } else {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()("#fullMenuMobile").addClass('open');
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.full-menu').addClass('open');
    }
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".menu_main li").on('mouseenter', function (e) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).find('.dropped').addClass('hovered');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".dropped").on('mouseleave', function () {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).removeClass('hovered');
    });
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("li.toggle-drop").click(function () {
    var click_id = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).data("open");
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#" + click_id).toggle();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).toggleClass("arrow-up");
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#newsGallery').each(function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).append('<span class="new-owl-button owl_left"></span><span class="new-owl-button owl_right"></span>');
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.new-owl-button').on('click', function () {
    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).hasClass('owl_left')) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).closest('.owl-carousel').trigger('prev.owl.carousel');
    } else {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).closest('.owl-carousel').trigger('next.owl.carousel');
    }
  });
});
...
module.exports = __webpack_require__(/*! H:\xampp\htdocs\sngs\src\assets\js\app.js */"./src/assets/js/app.js");
